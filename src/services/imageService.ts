...
export class ImageGenerationService {
  ...
  async generateWithImgBo(prompt: string, size: string = "1024x1024"): Promise<string> {
    const response = await fetch(`${this.baseUrl}/api/api/img-bo`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async generateWithGptImager(prompt: string): Promise<string> {
    const response = await fetch(`${this.baseUrl}/api/api/gpt-imager/create`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async generateWithSeedream4(prompt: string): Promise<string> {
    const response = await fetch(`${this.baseUrl}/api/api/seedream-4/create`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  // New Image Editing APIs
  async editWithGptImager(prompt: string, imageUrl: string): Promise<string> {
    const response = await fetch(`${this.baseUrl}/api/api/gpt-imager/edit`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async editWithSeedream4(prompt: string, imageUrls: string[]): Promise<string> {
    const response = await fetch(`${this.baseUrl}/api/api/seedream-4/edit`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  // Quality Enhancement API
  async enhanceQuality(imageUrl: string): Promise<string> {
    const response = await fetch(`${this.baseUrl}/api/api/quality-enhance`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
